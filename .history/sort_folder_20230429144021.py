...
def main():
    ...
    try:
        ...
        print("Будь ласка вкажіть цільовий шлях в параметрах")
        exit()
    ...
    print("Знайдено файли відомих типів:", ", ".join(f for f in found_known))
    print("Знайдено файли невідомих типів:", ", ".join(f for f in found_unknown))
