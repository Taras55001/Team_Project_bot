...
- ADD TAG: додає тег до нотатки. Формат: add tag перші*літери*нотатки... #тег
...
- CHANGE NOTE: змінює зміст нотатки. Формат: change note (перші*літери*нотатки... або #тег) новий_зміст
- CHANGE STATUS: змінює статус нотатки на "виконано" зі збереженням дати. Формат: change status (перші*літери*нотатки... або #тег)
...
- DEL NOTE: видаляє нотатку. Формат: del note (перші*літери*нотатки... або #тег)
...
- SEARCH NOTE: знаходить співпадіння в нотатках від 1 символу або за тегом. Формат: search note (перші*літери*нотатки... або #тег)
